...
def predict_price(year,town,flat_type,flr_area_sqm,flat_model,stry_start,stry_end,re_les_year,
    ...
    with open(r"C:\Users\user\Downloads\Python_DS_Jupyter\MDE89_guvi\Project\Resale_Flat_Prices_Model_1.pkl","rb") as f:
...
if select == "Home":
    img= Image.open(r"C:\Users\user\Desktop\Project env\flat.jfif")
    st.image(img)
